...
import { Location, Product, ReceiptLine } from '../../types';
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Record incoming stock from a supplier</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              className={`input ${errors.supplierName ? 'border-red-500' : ''}`}
